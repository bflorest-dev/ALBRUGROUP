...
const ESTADO_BADGES: Record<string, EstadoBadge> = {
  ...
  ABIERTO: { label: 'Abierto', severity: 'info' },
  CERRADO_PAGO_CLIENTE: { label: 'Cerrado cliente', severity: 'success' },
  CERRADO_PAGO_EMPRESA: { label: 'Cerrado empresa', severity: 'warn' },
  CERRADO_BAJA: { label: 'Cerrado baja', severity: 'danger' },
  CERRADO_BAJA_ADEUDO: { label: 'Baja por adeudo', severity: 'danger' },
  PAGADO_CLIENTE: { label: 'Pago cliente', severity: 'success' },
  PAGADO_EMPRESA: { label: 'Pago empresa', severity: 'warn' },
  COMPROMETIDO: { label: 'Compromiso', severity: 'warn' },
