/**
 * CONSTANTES DE TIPIFICACIÃ“N
 * 
 * Datos centralizados de los bloques de tipificaciÃ³n
 * para ASESOR_BACKOFFICE y mÃ³dulos relacionados.
 */

import type { TipificationBlock } from '@shared/types';

/**
 * Bloques de tipificaciÃ³n con todas sus opciones
 * Estructura jerÃ¡rquica: Bloque â†’ Opciones
 */
export const TIPIFICATION_BLOCKS: TipificationBlock[] = [
  {
    ...
    icon: 'hourglass',
    label: 'SIN GESTIONAR',
    description: 'Estados sin gestiÃ³n iniciada',
    color: '#1e3a8a',
    status: 'pending',
    options: [
  ...
  },
  {
    ...
    icon: 'search',
    label: 'EN REVISIÃ“N',
    description: 'Bajo revisiÃ³n o validaciÃ³n',
    color: '#6366f1',
    status: 'pending',
    options: [
  ...
  },
  {
    ...
    icon: 'calendar',
    label: 'PROGRAMADOS',
    description: 'InstalaciÃ³n programada',
    color: '#8b5cf6',
    status: 'pending',
    options: [
  ...
  },
  {
    ...
    description: 'Problemas comerciales o tÃ©cnicos',
    color: '#ef4444',
    status: 'rejected',
    options: [
...
/**
 * Mapa de bloques por ID para acceso rÃ¡pido
 */
...
/**
 * EstadÃ­sticas por bloque (para display)
 */
...
/**
 * Utilidad para obtener una opciÃ³n especÃ­fica dentro de un bloque
 */
...
/**
 * Utilidad para obtener el bloque y opciÃ³n seleccionados
 */
