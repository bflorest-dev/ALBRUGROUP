 ...
 * 
 * FSD Layer: entities/empleado/model
 */
...
import { validateDataOrThrow, NewEmployeeFormDataSchema } from '@shared/validation/schemas';
...
export class EmployeeService extends BaseService<Employee> {
   ...
   * 
   * @param employeeData - DTO mapeado desde UI (RegistrarEmpleadoRequest)
   *                       NO es FormData directamente, debe venir del mapper de features
   * @returns Employee object with backend response
   */
  static async createEmployee(employeeData: RegistrarEmpleadoRequest): Promise<Employee> {
    // Ya está mapeado, no necesita validación Zod aquí
    // La validación ocurrió en el mapper (features layer)
