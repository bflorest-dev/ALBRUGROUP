...
export function AmpliarOfertaModal({ oferta, isOpen, onClose, onSuccess }: AmpliarOfertaModalProps): React.ReactElement {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Ampliar Oferta" size="lg">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3 pr-12 text-sm text-slate-900 outline-none transition-all duration-150 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
              />
