...
import { z } from 'zod';
import type { CreateOfertaLaboralRequest, Negocio, Horario, PuestoObjetivo } from '@shared/types';
 ...
 */
export function useOfertaLaboralForm(
  options?: UseOfertaLaboralFormOptions
): UseOfertaLaboralFormReturn {
  const {
    register,
    handleSubmit,
    formState,
