...
>(({ activeSection, hideTabs = false, hideHeader = false, hideCreateButton = false }, ref) => {
  ...
  // Hooks de bandeja
  const bandejaReclutamiento = useBandejaReclutamiento({ enabled: isReclutamientoTab });
  const bandejaCapacitacion = useBandejaCapacitacion({ enabled: isReclutamientoTab });
