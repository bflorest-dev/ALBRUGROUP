...
import { EmployeeService } from '@entities/empleado/model';
import { ContractService } from '@entities/contrato/model';
import type { RegistrarContratoRequest } from '@shared/types';
import type { RegistrarEmpleadoRequest } from '@entities/empleado/model';
