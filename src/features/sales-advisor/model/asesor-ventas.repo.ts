...
import { parseApiResponse, leadAsesorVentasResponseArraySchema } from '@shared/api/responseSchemas';
import type {
...
import {
  ...
  datosPreventaResponseSchema,
  direccionResponseSchema,
  ofertaResponseSchema,
  tipificacionResponseSchema,
} from './asesor-ventas.schemas';
